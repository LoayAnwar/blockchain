...
class Block:
    ...
    def __repr__(self):
        return "index: " + str(self.index) + " previous_hash: " + str(self.previous_hash) + " time_stamp: "\
             + str(time.strftime('%H:%M:%S', time.localtime(self.timestamp)))
...
if x == 1:
    ...
    while True:
        blockchain_honest.create_random_transactions(100)
        blockchain_attacker.create_random_transactions(100)
